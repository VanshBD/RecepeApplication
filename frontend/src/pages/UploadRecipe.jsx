      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="mb-4">
          ...
          <input
            ...
            className="border border-gray-300 bg-black text-white px-4 py-2 w-3/4 md:w-1/2 lg:w-1/3"
            required
          />
        </div>
        <div className="mb-4">
          ...
          {ingredients.map((ingredient, index) => (
            <div key={index} className="flex items-center mb-2">
              <input
                ...
                className="border border-gray-300 bg-black text-white px-4 py-2 w-4/5 md:w-2/3 lg:w-1/2"
                required
              />
              <button
                type="button"
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            className="border border-gray-300 bg-black text-white px-4 py-2 w-full md:w-3/4 lg:w-2/3"
            required
          />
        </div>
        <div className="mb-4">
          ...
          <input
            ...
            className="border border-gray-300 bg-black text-white px-4 py-2 w-1/2 md:w-1/3"
            required
          />
        </div>
        <div className="mb-4">
          ...
          <input
            ...
            className="border border-gray-300 bg-black text-white px-4 py-2 w-1/3 md:w-1/4"
            required
          />
        </div>
        <div className="mb-4">
          ...
          <input
            ...
            className="border border-gray-300 bg-black text-white px-4 py-2 w-3/5"
          />
        </div>
        ...
        <button 
          type="submit" 
          className="bg-blue-500 text-white px-4 py-2 hover:bg-white hover:text-black transition"
        >
